...
impl PyModuleItemStmt {
    pub fn build(py: Python<'_>, node: swc_core::ecma::ast::Stmt) -> PyResult<Self> {
        Ok(PyModuleItemStmt {
            stmt: crate::pystmts::stmt_to_py(py, node)?,
        })
    }
}
...
impl PyModuleItemDecl {
    pub fn build(py: Python<'_>, node: swc_core::ecma::ast::ModuleDecl) -> PyResult<Self> {
        Ok(PyModuleItemDecl {
            decl: conv_module_decl(py, node)?,
        })
    }
}

pub fn conv_module_item(
    py: Python<'_>,
    item: swc_core::ecma::ast::ModuleItem,
) -> PyResult<Py<PyModuleItem>> {
    let base = PyModuleItem {};
    Ok(match item {
        swc_core::ecma::ast::ModuleItem::Stmt(s) => {
            Py::new(py, (PyModuleItemStmt::build(py, s)?, base))?
                .into_bound(py)
                .into_super()
                .unbind()
        }
        swc_core::ecma::ast::ModuleItem::ModuleDecl(d) => {
            Py::new(py, (PyModuleItemDecl::build(py, d)?, base))?
                .into_bound(py)
                .into_super()
                .unbind()
        }
...
pub fn conv_import_specifier(
    py: Python<'_>,
    spec: swc_core::ecma::ast::ImportSpecifier,
) -> PyResult<Py<PyImportSpecifier>> {
    let base = PyImportSpecifier {};
    Ok(match spec {
        swc_core::ecma::ast::ImportSpecifier::Named(n) => {
            Py::new(py, (PyImportNamedSpecifier::build(py, n)?, base))?
                .into_bound(py)
                .into_super()
                .unbind()
        }
        swc_core::ecma::ast::ImportSpecifier::Default(d) => {
            Py::new(py, (PyImportDefaultSpecifier::build(py, d)?, base))?
                .into_bound(py)
                .into_super()
                .unbind()
        }
        swc_core::ecma::ast::ImportSpecifier::Namespace(n) => {
            Py::new(py, (PyImportStarAsSpecifier::build(py, n)?, base))?
                .into_bound(py)
                .into_super()
                .unbind()
        }
...
pub fn conv_import_specifiers(
    py: Python<'_>,
    specs: Vec<swc_core::ecma::ast::ImportSpecifier>,
) -> PyResult<Vec<Py<PyImportSpecifier>>> {
    specs
        .into_iter()
        .map(|s| conv_import_specifier(py, s))
        .collect()
}
...
pub fn conv_export_specifier(
    py: Python<'_>,
    spec: swc_core::ecma::ast::ExportSpecifier,
) -> PyResult<Py<PyExportSpecifier>> {
    let base = PyExportSpecifier {};
    Ok(match spec {
        swc_core::ecma::ast::ExportSpecifier::Namespace(n) => {
            Py::new(py, (PyExportNamespaceSpecifier::build(py, n)?, base))?
                .into_bound(py)
                .into_super()
                .unbind()
        }
        swc_core::ecma::ast::ExportSpecifier::Default(d) => {
            Py::new(py, (PyExportDefaultSpecifier::build(py, d)?, base))?
                .into_bound(py)
                .into_super()
                .unbind()
        }
        swc_core::ecma::ast::ExportSpecifier::Named(n) => {
            Py::new(py, (PyExportNamedSpecifier::build(py, n)?, base))?
                .into_bound(py)
                .into_super()
                .unbind()
        }
...
pub fn conv_export_specifiers(
    py: Python<'_>,
    specs: Vec<swc_core::ecma::ast::ExportSpecifier>,
) -> PyResult<Vec<Py<PyExportSpecifier>>> {
    specs
        .into_iter()
        .map(|s| conv_export_specifier(py, s))
        .collect()
}
...
impl PyDefaultDeclClass {
    pub fn build(py: Python<'_>, node: swc_core::ecma::ast::ClassExpr) -> PyResult<Self> {
        Ok(PyDefaultDeclClass {
            ident: match node.ident {
                Some(i) => Some(conv_ident(py, i)?),
                None => None,
            },
...
pub fn conv_default_decl(
    py: Python<'_>,
    decl: swc_core::ecma::ast::DefaultDecl,
) -> PyResult<Py<PyDefaultDecl>> {
    let base = PyDefaultDecl {};
    Ok(match decl {
        swc_core::ecma::ast::DefaultDecl::Class(c) => {
            Py::new(py, (PyDefaultDeclClass::build(py, c)?, base))?
                .into_bound(py)
                .into_super()
                .unbind()
        }
        swc_core::ecma::ast::DefaultDecl::Fn(f) => {
            Py::new(py, (PyDefaultDeclFn::build(py, f)?, base))?
                .into_bound(py)
                .into_super()
                .unbind()
        }
        swc_core::ecma::ast::DefaultDecl::TsInterfaceDecl(i) => {
            Py::new(py, (PyDefaultDeclTsInterface::build(py, *i)?, base))?
                .into_bound(py)
                .into_super()
                .unbind()
        }
...
pub fn conv_module_decl(
    py: Python<'_>,
    decl: swc_core::ecma::ast::ModuleDecl,
) -> PyResult<Py<PyModuleDecl>> {
    let base = PyModuleDecl {};
    Ok(match decl {
        swc_core::ecma::ast::ModuleDecl::Import(d) => {
            Py::new(py, (PyImportDecl::build(py, d)?, base))?
                .into_bound(py)
                .into_super()
                .unbind()
        }
        swc_core::ecma::ast::ModuleDecl::ExportDecl(d) => {
            Py::new(py, (PyExportDecl::build(py, d)?, base))?
                .into_bound(py)
                .into_super()
                .unbind()
        }
        swc_core::ecma::ast::ModuleDecl::ExportNamed(d) => {
            Py::new(py, (PyNamedExport::build(py, d)?, base))?
                .into_bound(py)
                .into_super()
                .unbind()
        }
        swc_core::ecma::ast::ModuleDecl::ExportDefaultDecl(d) => {
            Py::new(py, (PyExportDefaultDecl::build(py, d)?, base))?
                .into_bound(py)
                .into_super()
                .unbind()
        }
        swc_core::ecma::ast::ModuleDecl::ExportDefaultExpr(d) => {
            Py::new(py, (PyExportDefaultExpr::build(py, d)?, base))?
                .into_bound(py)
                .into_super()
                .unbind()
        }
        swc_core::ecma::ast::ModuleDecl::ExportAll(d) => {
            Py::new(py, (PyExportAll::build(py, d)?, base))?
                .into_bound(py)
                .into_super()
                .unbind()
        }
        swc_core::ecma::ast::ModuleDecl::TsImportEquals(d) => {
            Py::new(py, (PyTsImportEqualsDecl::build(py, *d)?, base))?
                .into_bound(py)
                .into_super()
                .unbind()
        }
        swc_core::ecma::ast::ModuleDecl::TsExportAssignment(d) => {
            Py::new(py, (PyTsExportAssignment::build(py, d)?, base))?
                .into_bound(py)
                .into_super()
                .unbind()
        }
        swc_core::ecma::ast::ModuleDecl::TsNamespaceExport(d) => {
            Py::new(py, (PyTsNamespaceExportDecl::build(py, d)?, base))?
                .into_bound(py)
                .into_super()
                .unbind()
        }
